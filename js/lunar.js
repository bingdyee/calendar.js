...
function Lunar() {
  ...
  this.yueLiHTML = function (By, Bm, curJD) {
    ...
    var sty_head = ' style="font-family: 宋体; font-size: 14px; text-align: center; background-color: #c5af90; color: #000000; font-weight: bold" ';
    ...
    var ta0 = '<tr><td colspan=7 style="background-color:#95684a" style="color=#FFFF00">' + c + '</td></tr>'; //显示年号
